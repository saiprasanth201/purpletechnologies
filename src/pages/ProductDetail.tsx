...
import { MapPin, PlayCircle, BookText, FileText } from 'lucide-react'; // Import PlayCircle, BookText, FileText for links
...
const g18CommonDetails = {
    ...
    additionalImages: ['https://pictortelematics.com/images/1732280823_1726920513_PT%2018%20%284G%29%20Photo.jpeg'], // Changed to array for consistency
    ...
    additionalSpecs: [
        ...
        ['Dimensions', 'Compact'], // Placeholder, add actual if available
        ['Weight', 'Lightweight'], // Placeholder, add actual if available
    ]
};
...
const products = [
    {
        ...
        description: 'PT-ID02 is a reliable ID Card personal tracker that integrates GSM, GPS, GPRS, AGPS, and Optional wifi and LBS technologies to provide accurate real-time tracking. It is a device to track the safety of your loved one. It can be used for children, old citizens, and all with special needs. Its functions include tracking, geo fence, and trace playback, and comes with a mic that supports 2-way communication, voice recording, and sound call back for efficient personal safety. Its compact lightweight design makes it more comfortable to carry with a 1500mAh rechargeable battery for better durable performance. It provides accurate and fast monitoring through APP, Web, or SMS platforms and has an SOS feature in case of emergency. It is best for the personal safety and security.',
        imageUrl: 'https://pictortelematics.com/images/1733915152_PT-ID02%20%281%29.png',
        additionalImages: [ // Changed to array to hold multiple images
            'https://pictortelematics.com/images/1733915152_PT-ID02%20%2810%29.png',
            'https://pictortelematics.com/images/1733915152_PT-ID02%20%282%29.png',
            'https://pictortelematics.com/images/1733915152_PT-ID02%20%288%29.png'
        ],
        videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', // Placeholder YouTube video URL
        specifications: [
            ['Device Name', 'ID Card with GPS tracker'],
            ['Model Name', 'PT-ID02'],
            ['Network', '2G'],
            ['GSM', '850/900/1800/1900MHz'],
            ['GPRS', 'Class 12'],
            ['Positioning Modes', 'GPS + AGPS + Wifi (optional) + LBS'],
            ['Tracking System', 'APP + Web + SMS'],
            ['Dimensions', '85.5mm x 54mm x 7.2mm'],
            ['Weight', '46g'],
            ['Battery', 'Rechargeable 1500mAh Li-polymer'],
            ['GPS Location Accuracy', 'Within 10 meters outdoor'],
            ['Wifi Location Accuracy', 'Within 50 meters'],
            ['LBS Location Accuracy', 'Above 100 meters'],
            ['Working Temperature', '-20°C to 45°C'],
            ['Humidity', '5% to 95%'],
        ],
        additionalSpecs: [
            ['Real-Time Tracking', 'Provides continuous live tracking via APP, web, or SMS.'],
            ['Trace Playback', 'Review the history of the vehicle\'s routes for insights.'],
            ['Geo-Fence Alerts', 'Set boundaries and receive alerts when entering/exiting areas.'],
            ['Positioning Modes', 'GPS, AGPS, Wifi (optional), and LBS for versatile positioning.'],
            ['Voice Recording + Pick-Up', 'Voice recording and remote audio pick-up for security.'],
            ['Two-Way SOS Communication', 'Supports one/two-way SOS communication (requires GPS SIM).'],
            ['GPS Accuracy', 'GPS accuracy within 10 meters in outdoor settings.'],
            ['Wifi Location Accuracy', 'Wifi-based location accuracy within 50 meters (optional).'],
            ['LBS Location Accuracy', 'LBS accuracy within 100 meters or more.'],
            ['Sound Call Back', 'Remotely activate sound call-back for real-time monitoring.'],
            ['Rechargeable Battery', '1500mAh Li-polymer battery for long-lasting use.'],
        ]
    },
...

    {
        ...
        description: 'The PL1800 Smart Electronic Lock is designed with solar charging capability, ensuring continuous power for secure and worry-free use. Equipped with GPS + LBS positioning, a powerful 18000mAh rechargeable battery, and IP67 waterproofing, this lock provides reliable performance in any environment. Unlock conveniently using a password, Bluetooth, or authorized RFID key, and receive instant alerts for tampering, low battery, and more. With support for up to 10 geofences and RFID keys for multi-user access, the PL800 is ideal for assets that require flexible, long-lasting security and real-time tracking.',
        imageUrl: 'https://pictortelematics.com/images/1732353659_Pl%20800.png',
        userManualUrl: '#', // Placeholder URL
        protocolUrl: '#', // Placeholder URL
        videoUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', // Placeholder YouTube video URL
        specifications: [
            ['Device Name', 'Smart Electronic Lock'],
            ['Model Name', 'PL800'],
            ['Weight', '950g'],
            ['Network Support', '2G / 3G / 4G, customizable'],
            ['Positioning Modes', 'GPS + LBS'],
            ['SIM Card Slot', '1 Nano SIM'],
            ['Battery', '18000mAh Rechargeable Lithium (21700 type) , Solar charging'],
            ['Sensor', '3-Axis Accelerometer for motion detection'],
            ['Buzzer & LED Indicator', 'Status reminders with LED & sound alerts'],
            ['Charging Requirement', '5V DC, 2A'],
            ['Bluetooth', 'Supported; enables data tracking and connection'],
            ['Unlock Options', 'Password, Authorized RFID Key, Bluetooth'],
            ['Firmware Update', 'Over-the-Air (OTA)'],
            ['Working Hour', '>30 Days TRA with 4pcs slave lock'],
            ['Waterproof', 'IP67'],
            ['Silicon Back Cover', 'Standard 50g'],
            ['Strong Magnet', 'Standard 45mm*45mm, 110g'],
            ['Solar Energy Panel', '2.3 W , 80g'],
        ],
        additionalSpecs: [
            ['Real-Time Location Tracking', 'Provides current location tracking via SMS command.'],
            ['Password Unlock', 'Unlocks the device using a password through SMS/GPRS.'],
            ['RFID Key Unlock', 'Allows unlocking by authorized RFID keys.'],
            ['Auto-Lock', 'Locks automatically when lock rope is inserted.'],
            ['Multi-Key Authorization', 'Supports up to 50 RFID keys for added flexibility.'],
            ['Geo-Fence Support', 'Can set up to 10 polygonal geo-fences for location-based alerts.'],
            ['Alerts & Notifications', 'Sends alerts for tampering, unauthorized access, unlocking, wrong password, vibration, entering/exiting geo-fence, low battery, and motor issues.'],
            ['Authorized Contacts', 'Allows up to 5 phone numbers to receive alerts and send commands.'],
            ['Lock & Unlock Reports', 'Tracks and reports lock/unlock status with timestamps.'],
            ['Wake-Up Source', 'Activated by vibration, RFID key, back cover removal, or lock rope insertion/unplugging.'],
            ['Polygonal Geo-Fence Alerts', 'Monitors entry/exit within designated geo-fences.'],
        ]
    },
            ...
            <div className="flex flex-col gap-10"> {/* Main container for all sections */}
                ...
                <div className="flex flex-col md:flex-row gap-8 bg-white/5 p-8 rounded-2xl border border-white/10 shadow-xl backdrop-blur-sm">
                    ...
                    <div className="md:w-1/2 space-y-4">
                        ...
                        <div className="flex flex-wrap gap-4"> {/* Container for multiple links */}
                            {product.userManualUrl && (
                                ...
                                >
                                    ...
                                    <span className="text-lg font-semibold">User Manual</span>
                                </a>
                            )}
                            {product.protocolUrl && (
                                <a
                                    href={product.protocolUrl}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="inline-flex items-center space-x-2 text-cyan-400 hover:text-cyan-300 transition-colors duration-200"
                                >
                ...
                {product.additionalImages && product.additionalImages.length > 0 && (
                    <div className="bg-white/5 p-6 rounded-2xl border border-white/10 shadow-xl backdrop-blur-sm flex flex-wrap justify-center items-center gap-4">
                        {product.additionalImages.map((imgUrl, idx) => (
                            <img
                                key={idx}
                                src={imgUrl}
                                alt={`${product.title} - View ${idx + 1}`}
                                className="w-32 h-32 md:w-48 md:h-48 rounded-lg border border-white/10 shadow-md object-cover"
                                onError={(e) => {
                                    e.currentTarget.src = placeholderImages[imageIndex++ % placeholderImages.length];
                                }}
                            />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        {product.specifications && product.specifications.length > 0 && (
                            <div className="bg-white/5 p-6 rounded-2xl border border-white/10 shadow-xl backdrop-blur-sm">
                                <h2 className="text-2xl font-semibold text-purple-400 mb-4">Product Specifications</h2>
                        ...
                        {product.additionalSpecs && product.additionalSpecs.length > 0 && (
                            <div className="bg-white/5 p-6 rounded-2xl border border-white/10 shadow-xl backdrop-blur-sm">
                                <h2 className="text-2xl font-semibold text-purple-400 mb-4">Product Features</h2>
                                <table className="w-full text-sm border-collapse">
                                    <tbody>
                                        {product.additionalSpecs.map(([key, value], index) => (
                                            <tr key={index} className="border-b border-white/5 last:border-b-0">
                                                <td className="px-4 py-3 font-medium text-white/80">{key}</td>
                                                <td className="px-4 py-3 text-gray-300">{value}</td>
                                            </tr>
